"""
skylinx/inherit/model_inherit.py

SkylinxModelBase — metaclass for SkylinxModel that enables field and method
...
Usage in an extension app:
    ...
    class AssetExtension(SkylinxModel):
...
to the extension app via INJECTION_MAP + SkylinxAutodetector.
"""
...
class SkylinxModelBase(ModelBase):
    """
    Metaclass for SkylinxModel.
