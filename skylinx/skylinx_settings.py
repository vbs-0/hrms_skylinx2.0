...
from skylinx.skylinx_apps import INSTALLED_APPS
...
DEFAULT_LDAP_CONFIG = {
    ...
    "BIND_DN": settings.env("BIND_DN", default="cn=admin,dc=skylinx,dc=com"),
    "BIND_PASSWORD": settings.env("BIND_PASSWORD", default="skylinx"),
    "BASE_DN": settings.env("BASE_DN", default="ou=users,dc=skylinx,dc=com"),
}
