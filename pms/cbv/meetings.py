...
@method_decorator(login_required, name="dispatch")
class MeetingsList(SkylinxListView):
    """
...
@method_decorator(login_required, name="dispatch")
class MeetingsNav(SkylinxNavView):
    """
    Nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class MeetingsDetailedView(SkylinxDetailedView):
    """
    detail view of page
    """
...
@method_decorator(login_required, name="dispatch")
class MeetingsFormView(SkylinxFormView):
    """
    Form View
    """
...
@method_decorator(login_required, name="dispatch")
class MeetingResponseFormView(SkylinxFormView):
    """
    Form View
    """
