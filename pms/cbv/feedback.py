...
@method_decorator(login_required, name="dispatch")
class FeedbackListView(SkylinxListView):
    """
    list view
    """
...
@method_decorator(login_required, name="dispatch")
class FeedbackGenericTabView(SkylinxTabView):
    """
...
@method_decorator(login_required, name="dispatch")
class AnonymousFeedbackTab(SkylinxListView):
    """
...
@method_decorator(login_required, name="dispatch")
class FeedbacknavView(SkylinxNavView):
    """
    navbar
    """
...
@method_decorator(login_required, name="dispatch")
class AddAnonymousFeedbackForm(SkylinxFormView):
    """
    form view
    """
...
class FeedbackUpdateFormView(SkylinxFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class AnounyFeedbackDetailView(SkylinxDetailedView):
