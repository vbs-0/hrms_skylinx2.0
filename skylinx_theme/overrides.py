...
Recruitment = get_skylinx_model_class(app_label="recruitment", model="recruitment")
AttendanceLateComeEarlyOut = get_skylinx_model_class(
    app_label="attendance", model="attendancelatecomeearlyOut"
)
Attendance = get_skylinx_model_class(app_label="attendance", model="attendance")
LeaveRequest = get_skylinx_model_class(app_label="leave", model="leaverequest")
Meetings = get_skylinx_model_class(app_label="pms", model="Meetings")
ResignationLetter = get_skylinx_model_class(
    app_label="offboarding", model="ResignationLetter"
)
AssetAssignment = get_skylinx_model_class(app_label="asset", model="AssetAssignment")
TimeSheet = get_skylinx_model_class(app_label="project", model="TimeSheet")
Deduction = get_skylinx_model_class(app_label="payroll", model="Deduction")
Task = get_skylinx_model_class(app_label="project", model="Task")
