...
@method_decorator(
    permission_required("skylinx_theme.view_skylinxcolortheme"),
    name="dispatch",
)
class ThemeView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["themes"] = SkylinxColorTheme.objects.all()
        ...
        default_theme = SkylinxColorTheme.get_default_theme()
...
@method_decorator(
    permission_required("skylinx_theme.change_skylinxcolortheme"),
    name="dispatch",
)
class ChangeThemeView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            theme = SkylinxColorTheme.objects.get(pk=theme_id)
        ...
        except SkylinxColorTheme.DoesNotExist:
    ...
    def _render_themes(self, request, active_theme=None, status=200):
        ...
        themes = SkylinxColorTheme.objects.all()
        active_company = getattr(request, "active_company", None)
...
@method_decorator(
    permission_required("skylinx_theme.add_skylinxcolortheme"),
    name="dispatch",
)
