...
class Offboarding(SkylinxModel):
    """
    Offboarding model
    """
...
class OffboardingStage(SkylinxModel):
    """
    Offboarding model
    """
...
class OffboardingStageMultipleFile(SkylinxModel):
    """
...
class ResignationLetter(SkylinxModel):
    """
...
class OffboardingTask(SkylinxModel):
    """
...
class EmployeeTask(SkylinxModel):
    """
    EmployeeTask model
    """
...
class OffboardingNote(SkylinxModel):
    """
    OffboardingNote
    """
...
class OffboardingGeneralSetting(SkylinxModel):
    """
