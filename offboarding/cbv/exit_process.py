...
from skylinx_views.generic.cbv.kanban import SkylinxKanbanView
from skylinx_views.generic.cbv.pipeline import Pipeline
...
class OffboardingStageFormView(SkylinxFormView):
    """
...
class OffboardingStageAddEmployeeForm(SkylinxFormView):
    """
    form view for create button
    """
...
class OffboardingCreateFormView(SkylinxFormView):
    """
...
class OffboardingTaskFormView(SkylinxFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class ExitProcessDetailView(SkylinxDetailedView):
    """
    detail view
    """
...
@method_decorator(login_required, name="dispatch")
class OffboardingPipelineView(SkylinxSectionView):
    """
...
@method_decorator(login_required, name="dispatch")
class OffboardingPipelineNav(SkylinxNavView):
    """
...
@method_decorator(login_required, name="dispatch")
class PipeLineTabView(SkylinxTabView):
    """
    Pipeline Tab View
    """
...
@method_decorator(login_required, name="dispatch")
class OffboardingKanbanView(SkylinxKanbanView):
    """
...
@method_decorator(login_required, name="dispatch")
class OffboardingEmployeeList(SkylinxListView):
    """
...
@method_decorator(login_required, name="dispatch")
class DashboardTaskListview(SkylinxListView):
    """
...
if apps.is_installed("asset"):
    ...
    class DashboardNotReturndAsssets(SkylinxListView):
        """
        For dashboard task status table
        """
        ...
        def __init__(self, *args, **kwargs):
            AssetAssignment = get_skylinx_model_class(
...
if apps.is_installed("pms"):
    ...
    class DashboardFeedbackView(SkylinxListView):
        """
        For dashboard task status table
        """
        ...
        def __init__(self, *args, **kwargs):
            self.Feedback = get_skylinx_model_class(app_label="pms", model="feedback")
