...
@method_decorator(login_required, name="dispatch")
class ReimbursementsAndEncashmentsTabView(SkylinxTabView):
    """
    Tab View
    """
...
@method_decorator(login_required, name="dispatch")
class ReimbursementsAndEncashmentsListView(SkylinxListView):
    """
    list view
    """
...
@method_decorator(login_required, name="dispatch")
class ReimbursementsNav(SkylinxNavView):
    """
    Nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class ReimbursementsDetailView(SkylinxDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class ReimbursementsFormView(SkylinxFormView):
    """
