...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="payroll.view_allowance"), name="dispatch")
class AllowanceListView(SkylinxListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="payroll.view_allowance"), name="dispatch")
class AllowanceNavView(SkylinxNavView):
    """
    nav bar of the page
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="payroll.view_allowance"), name="dispatch")
class AllowancesCardView(SkylinxCardView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="payroll.view_allowance"), name="dispatch")
class AllowanceDetailView(SkylinxDetailedView):
    """
