...
class FederalTaxFormView(SkylinxFormView):
    """
...
class TaxBracketCreateForm(SkylinxFormView):
    """
...
class TaxBracketNavView(SkylinxNavView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("payroll.view_taxbracket"), name="dispatch")
class TaxBracketListView(SkylinxListView):
    """
