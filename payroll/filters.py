...
class ContractFilter(SkylinxFilterSet):
    """
...
class AllowanceFilter(SkylinxFilterSet):
    """
...
class DeductionFilter(SkylinxFilterSet):
    """
...
class PayslipFilter(SkylinxFilterSet):
    """
...
class LoanAccountFilter(SkylinxFilterSet):
    """
    LoanAccountFilter
    """
...
class ReimbursementFilter(SkylinxFilterSet):
    """
    ReimbursementFilter
    """
...
class TaxBracketFilter(SkylinxFilterSet):
    """
...
class FilingStatusFilter(SkylinxFilterSet):
    """
    Filter set class for TaxBracket model.
    """
...
class PayslipAutoGenerateFilter(SkylinxFilterSet):
