...
class LinkedinSettingSectionView(views.SkylinxSectionView):
    """
...
class LinkedInSettingNavView(views.SkylinxNavView):
    """
...
class LinkedInAccountFormView(views.SkylinxFormView):
    """
    LinkedInForm View
    """
...
class LinkedInSettingListView(views.SkylinxListView):
    """
