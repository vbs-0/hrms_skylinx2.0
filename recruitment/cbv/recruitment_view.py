...
class RecruitmentList(SkylinxListView):
    """
...
class RecruitmentNav(SkylinxNavView):
    """
    For nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class RecruitmentNewSkillForm(SkylinxFormView):
    """
...
class RecruitmentForm(SkylinxFormView):
    """
    Form View
    """
...
@method_decorator(login_required, name="dispatch")
class AddCandidateFormView(SkylinxFormView):
    """
...
class RecruitmentFormDuplicate(SkylinxFormView):
    """
    Duplicate form view
    """
...
class RecruitmentDetailView(SkylinxDetailedView):
    """
    detail view of page
    """
