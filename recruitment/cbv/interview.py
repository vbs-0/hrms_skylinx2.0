...
class InterviewNavView(SkylinxNavView):
    """
    nav bar of the page
    """
...
class InterviewLIstView(SkylinxListView):
    """
...
class InterviewDetailView(SkylinxDetailedView):
    """
    detailed view
    """
...
class InterviewForm(SkylinxFormView):
    """
    form view
    """
