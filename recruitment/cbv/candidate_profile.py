...
from skylinx_views.generic.cbv.views import SkylinxListView, SkylinxProfileView
...
class CandidateProfileView(SkylinxProfileView):
    """
...
class CandidateProfileTasks(SkylinxListView):
    """
