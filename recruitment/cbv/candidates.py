...
class ListCandidates(SkylinxListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter(perm="recruitment.view_candidate"), name="dispatch")
class CardCandidates(SkylinxCardView):
    """
    For card view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter(perm="recruitment.view_candidate"), name="dispatch")
class CandidateNav(SkylinxNavView):
    """
    For nav bar
    """
...
class CandidateDetail(SkylinxDetailedView):
    """
    Candidate detail
    """
...
class ToSkillZoneFormView(SkylinxFormView):
    """
    Form View
    """
...
class RejectReasonFormView(SkylinxFormView):
    """
    Form View
    """
