...
from skylinx_views.generic.cbv.views import SkylinxDetailedView, SkylinxFormView
...
class QuestionFormView(SkylinxFormView):
    """
...
class QuestionDuplicateFormView(SkylinxFormView):
    """
...
class SurveyTemplateFormView(SkylinxFormView):
    """
...
class RecruitmentSurveyDetailView(SkylinxDetailedView):
    """
