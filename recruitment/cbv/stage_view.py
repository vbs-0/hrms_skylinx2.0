...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="recruitment.view_stage"), name="dispatch")
class StageList(SkylinxListView):
    """
    List view of stage
    """
...
class StageFormView(SkylinxFormView):
    """
    Form View
    """
...
class StageDuplicateForm(SkylinxFormView):
    """
    Duplicate form view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="recruitment.view_stage"), name="dispatch")
class StageDetailView(SkylinxDetailedView):
    """
    detail view of page
    """
