...
class SkillZoneStatusList(SkylinxListView):
    """
...
class CandidateOnOnboardList(SkylinxListView):
    """
...
class CurrentHiringList(SkylinxListView):
    """
...
class OnGoingRecruitmentList(SkylinxListView):
    """
