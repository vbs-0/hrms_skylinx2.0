...
@method_decorator(login_required, name="dispatch")
class AttendancesRequestTabView(SkylinxTabView):
    """
...
@method_decorator(login_required, name="dispatch")
class AttendancesRequestListView(SkylinxListView):
    """
    list view
    """
...
def _request_tab_badge_count(request, view_cls):
    """Same queryset rules as the tab's SkylinxListView (filters, subordinates)."""
    view = view_cls()
...
@method_decorator(login_required, name="dispatch")
class AttendanceRequestNav(SkylinxNavView):
    """
    nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class AttendanceListTabDetailView(SkylinxDetailedView):
    """
    Detail view of page
    """
...
@method_decorator(login_required, name="dispatch")
class NewAttendanceRequestFormView(SkylinxFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class BulkAttendanceRequestFormView(SkylinxFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class UpdateAttendanceRequestFormView(SkylinxFormView):
    """
