...
@method_decorator(login_required, name="dispatch")
class HourAccountList(SkylinxListView):
    """
    List view
    """
...
@method_decorator(login_required, name="dispatch")
class HourAccountNav(SkylinxNavView):
    """
    Nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class HourAccountDetailView(SkylinxDetailedView):
    """
    Detail View
    """
...
class HourAccountFormView(SkylinxFormView):
    """
    Form View
    """
