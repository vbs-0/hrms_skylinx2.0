...
class GenericGraceTimeListView(SkylinxListView):
    """
...
class DefaultGraceTimeNav(SkylinxNavView):
    """
    Nav bar
    """
...
class GraceTimeNav(SkylinxNavView):
    """
    Nav bar
    """
...
class GraceTimeFormView(SkylinxFormView):
    """
