...
class AttendanceActivity(SkylinxModel):
    """
...
class BatchAttendance(SkylinxModel):
    """
...
class Attendance(SkylinxModel):
    ...
    def serialize(self):
        ...
        serialized_data = {
            ...
            "shift_id": self.shift_id.id if self.shift_id else None,
            ...
            "batch_attendance_id": (
                self.batch_attendance_id.id if self.batch_attendance_id else None
            ),
...
class AttendanceOverTime(SkylinxModel):
    """
...
class AttendanceLateComeEarlyOut(SkylinxModel):
    """
...
class AttendanceValidationCondition(SkylinxModel):
    """
...
class AttendanceGeneralSetting(SkylinxModel):
    """
