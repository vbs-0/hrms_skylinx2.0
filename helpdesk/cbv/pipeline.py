...
class TicketPipelineView(SkylinxSectionView):
    """
...
@method_decorator(login_required, name="dispatch")
class TicketPipelineNav(SkylinxNavView):
    """
...
@method_decorator(login_required, name="dispatch")
class TicketTabView(SkylinxTabView):
    """
    Pipeline List View
    """
...
@method_decorator(login_required, name="dispatch")
class TicketListView(SkylinxListView):
    """
    Pipeline List View
    """
...
@method_decorator(login_required, name="dispatch")
class TicketCardView(SkylinxKanbanView):
    model = Ticket
    filter_class = TicketFilter
    group_key = "status"
    records_per_page = 10
