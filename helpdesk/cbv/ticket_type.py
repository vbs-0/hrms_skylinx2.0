...
class TicketsListView(SkylinxListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="helpdesk.view_tickettype"), name="dispatch")
class TicketsNavView(SkylinxNavView):
    """
...
class TicketTypeCreateForm(SkylinxFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class TicketsCreateFormView(SkylinxFormView):
    """
