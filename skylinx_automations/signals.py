...
from skylinx.signals import post_bulk_update, pre_bulk_update
...
def start_automation():
    ...
    from skylinx_automations.methods.methods import get_model_class, split_query_string
    ...
    @receiver(post_delete, sender=SkylinxMailTemplate)
    @receiver(post_save, sender=SkylinxMailTemplate)
...
def send_automated_mail(
    ...
    from skylinx_automations.methods.methods import evaluate_condition, operator_map
...
def send_mail(request, automation, instance):
    ...
    from skylinx_automations.methods.methods import (
        get_model_class,
