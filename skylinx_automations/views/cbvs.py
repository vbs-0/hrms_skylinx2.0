"""
skylinx_automations/views/cbvs.py
"""
...
@method_decorator(
    permission_required("skylinx_automations.view_mailautomation"), name="dispatch"
)
class AutomationSectionView(views.SkylinxSectionView):
    """
    ...
    template_name = "skylinx_automations/section_view.html"
...
class AutomationNavView(views.SkylinxNavView):
    """
    AutomationNavView
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("skylinx_automations.change_mailautomation"), name="dispatch"
)
class AutomationFormView(views.SkylinxFormView):
    """
    AutomationFormView
    """
...
class AutomationListView(views.SkylinxListView):
    """
    AutomationListView
    """
...
class AutomationDetailedView(views.SkylinxDetailedView):
    """
...
class LoadAutomationsView(View):
    template_name = "skylinx_automations/load_automation.html"
    ...
    def post(self, request):
        ...
        for template_json in templates_raw:
            if template_json["pk"] in required_template_pks:
                ...
                existing = SkylinxMailTemplate.objects.filter(
        ...
        for automation_json in selected_automations:
            ...
            mail_template = SkylinxMailTemplate.objects.filter(
                body=template_body
            ).first()
