"""
Configuration for skylinx_dbtemplate.

Reads from Django settings with SKYLINX_DBTEMPLATE_* prefix.
...
def get_setting(name, default=None):
    """Get a setting with SKYLINX_DBTEMPLATE_ prefix."""
    full_name = f"SKYLINX_DBTEMPLATE_{name}"
    return getattr(settings, full_name, default)


# Cache backend name from CACHES (e.g. "default" or "skylinx_dbtemplate")
