...
from skylinx.decorators import login_required as func_login_required
from skylinx.http.response import SkylinxRedirect
from skylinx.signals import post_generic_delete, pre_generic_delete
...
from skylinx_views.forms import SavedFilterForm
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.SkylinxModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(SkylinxFormView):
    """
    SavedFilter
    """
...
@method_decorator(login_required, name="dispatch")
class DynamiListView(SkylinxListView):
    """
...
@method_decorator(login_required, name="dispatch")
class SkylinxDeleteConfirmationView(View):
    """
    ...
    def post(self, *args, **kwargs):
        ...
        return SkylinxFormView.HttpResponse(script=script)
...
def export_data(request, *args, **kwargs):
    ...
    model_path = request.GET.get("model")
    if not model_path:
        return SkylinxRedirect(request, message=_("No matching query found."))
