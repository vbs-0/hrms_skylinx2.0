"""
skylinx_views/urls.py
"""

from django.urls import path

from skylinx_views import views
from skylinx_views.generic.cbv import history
from skylinx_views.generic.cbv.views import SkylinxListView, ReloadMessages
...
urlpatterns = [
    ...
    path(
        "generic-delete/",
        views.SkylinxDeleteConfirmationView.as_view(),
        name="generic-delete",
    ),
    path(
        "skylinx-history-revert/<int:pk>/<int:history_id>/",
        history.SkylinxHistoryView.as_view(),
        name="history-revert",
    ),
    path(
