...
from skylinx.signals import post_generic_import, pre_generic_import
from skylinx_views import models
from skylinx_views.cbv_methods import (  # update_initial_cache,
    assign_related,
    export_xlsx,
...
from skylinx_views.forms import DynamicBulkUpdateForm, ToggleColumnForm
...
class SkylinxListView(ListView):
    """
    SkylinxListView
    """
    ...
    template_name: str = "generic/skylinx_list_table.html"
...
class SkylinxSectionView(TemplateView):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, SkylinxListView)
    ...
    template_name = "generic/skylinx_section.html"
...
@method_decorator(hx_request_required, name="dispatch")
class SkylinxDetailedView(DetailView):
    """
    HorillDetailedView
    """
...
@method_decorator(hx_request_required, name="dispatch")
class SkylinxTabView(TemplateView):
    """
    SkylinxTabView
    """

    view_id: str = get_short_uuid(3, "htv")
    template_name = "generic/skylinx_tabs.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.query_params = {}
        # update_initial_cache(request, CACHE, SkylinxTabView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[SkylinxTabView] = context

        return context


@method_decorator(hx_request_required, name="dispatch")
class SkylinxCardView(ListView):
    """
    SkylinxCardView
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, SkylinxCardView)
...
@method_decorator(hx_request_required, name="dispatch")
class SkylinxFormView(FormView):
    """
    SkylinxFormView
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        # update_initial_cache(request, CACHE, SkylinxFormView)
    ...
    def get_form(self, form_class=None):
        ...
        if not isinstance(existing_form, forms.BaseForm):
            ...
            # CACHE.get(self.request.session.session_key + "cbv")[SkylinxFormView] = form
            self.form = form
        return self.form
...
@method_decorator(hx_request_required, name="dispatch")
class SkylinxNavView(TemplateView):
    """
    SkylinxNavView
    ...
    template_name = "generic/skylinx_nav.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, SkylinxNavView)
...
@method_decorator(hx_request_required, name="dispatch")
class SkylinxProfileView(DetailView):
    """
