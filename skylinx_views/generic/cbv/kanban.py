"""
skylinx_views/generic/cbv/kanban.py
"""

from django.core.paginator import EmptyPage, PageNotAnInteger, Paginator
from django.db import models

from skylinx_views.cbv_methods import get_nested_field
from skylinx_views.generic.cbv.views import SkylinxCardView


class SkylinxKanbanView(SkylinxCardView):
    group_key: str = ""
    group_filter_class = None
    template_name: str = "generic/skylinx_kanban_view.html"
    kanban_attrs: str = ""
