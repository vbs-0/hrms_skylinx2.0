...
@method_decorator(login_required, name="dispatch")
class AllocationList(SkylinxListView):
    """
...
@method_decorator(login_required, name="dispatch")
class AssetRequestList(SkylinxListView):
    """
    Asset Request Tab
    """
...
@method_decorator(login_required, name="dispatch")
class RequestAndAllocationTab(SkylinxTabView):
    """
    Tab View
    """
...
@method_decorator(login_required, name="dispatch")
class RequestAndAllocationNav(SkylinxNavView):
    """
    Nav bar
    """
...
class AssetDetailView(SkylinxDetailedView):
    """
...
class AssetRequestDetailView(SkylinxDetailedView):
    """
...
class AssetAllocationDetailView(SkylinxDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class AssetRequestCreateForm(SkylinxFormView):
    """
...
class AssetAllocationFormView(SkylinxFormView):
    """
...
class AssetApproveFormView(SkylinxFormView):
    """
    Create Asset Allocation
    """
...
class AssetRenewalNav(SkylinxNavView):
    """
...
class ExpiringAssignmentList(SkylinxListView):
    """
...
class AssetReassignFormView(SkylinxFormView):
    """
