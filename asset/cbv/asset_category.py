...
from skylinx_views.views import SkylinxDeleteConfirmationView


@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("asset.view_assetcategory"), name="dispatch")
class AssetCategoryFormView(SkylinxFormView):
    """
...
class AssetFormView(SkylinxFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("asset.view_assetcategory"), name="dispatch")
class AssetCategoryDuplicateFormView(SkylinxFormView):
    """
...
class AssetDuplicateFormView(SkylinxFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class AssetReportFormView(SkylinxFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("asset.view_asset"), name="dispatch")
class AssetCategoryNav(SkylinxNavView):
    """
...
class AssetDeleteConfirmationView(SkylinxDeleteConfirmationView):
    ...
    def post(self, *args, **kwargs):
        ...
        return SkylinxFormView.HttpResponse(targets_to_reload=[".filterButton"])
