...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="leave.view_leavetype"), name="dispatch")
class LeaveTypeListView(SkylinxListView):
    """
    list view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="leave.view_leavetype"), name="dispatch")
class LeaveTypeNavView(SkylinxNavView):
    """
    navbar
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="leave.view_leavetype"), name="dispatch")
class LeaveTypeDetailView(SkylinxDetailedView):
    """
    detail view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="leave.view_leavetype"), name="dispatch")
class LeaveTypeCardView(SkylinxCardView):
    """
    card view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="leave.view_leavetype"), name="dispatch")
class LeaveTypeAssignForm(SkylinxFormView):
    """
    form view
    """
