...
@method_decorator(login_required, name="dispatch")
class LeaveAllocationRequestList(SkylinxListView):
    """
...
@method_decorator(login_required, name="dispatch")
class LeaveAllocationRequestTab(SkylinxTabView):
    """
    Tab View
    """
...
@method_decorator(login_required, name="dispatch")
class LeaveAllocationRequestNav(SkylinxNavView):
    """
    Nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class LeaveAllocationRequestDetailView(SkylinxDetailedView):
    """
    detail view of page
    """
...
@method_decorator(login_required, name="dispatch")
class LeaveAllocationRequestFormView(SkylinxFormView):
    """
    Form View
    """
