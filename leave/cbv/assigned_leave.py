...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("leave.view_availableleave"), name="dispatch")
class AssignedleaveList(SkylinxListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("leave.view_availableleave"), name="dispatch")
class AssignedLeaveNavView(SkylinxNavView):
    """
    navbar of the page
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("leave.view_availableleave"), name="dispatch")
class AssignedLeaveDetailView(SkylinxDetailedView):
    """
    detail view
    """
...
# not done
class AssignedLeaveFormView(SkylinxFormView):
    """
    form view
    """
