...
@method_decorator(login_required, name="dispatch")
class RestrictedDaysList(SkylinxListView):
    """
...
@method_decorator(login_required, name="dispatch")
class RestrictedDaysNav(SkylinxNavView):
    """
    Nav bar
    """
...
class RestrictedDaysFormView(SkylinxFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class RestrictedDaysDetailView(SkylinxDetailedView):
    """
    detail view of page
    """
