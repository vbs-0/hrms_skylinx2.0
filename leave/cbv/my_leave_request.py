...
@method_decorator(login_required, name="dispatch")
class MainParentListView(SkylinxListView):
    """
...
@method_decorator(login_required, name="dispatch")
class MyLeaveRequestNavView(SkylinxNavView):
    """
    nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class MyLeaveRequestDetailView(SkylinxDetailedView):
    """
    detail view of page
    """
...
@method_decorator(login_required, name="dispatch")
class MyLeaveRequestForm(SkylinxFormView):
    """
    form view
    """
...
@method_decorator(login_required, name="dispatch")
class MyLeaveRequestSingleForm(SkylinxFormView):
    """
