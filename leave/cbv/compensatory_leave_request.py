...
@method_decorator(login_required, name="dispatch")
@method_decorator(is_compensatory_leave_enabled(), name="dispatch")
class CompensatoryListView(SkylinxListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(is_compensatory_leave_enabled(), name="dispatch")
class CompensatoryNavView(SkylinxNavView):
    """
    nav bar
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(is_compensatory_leave_enabled(), name="dispatch")
class CompensatoryLeaveTabView(SkylinxTabView):
    """
    tabview of the page
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(is_compensatory_leave_enabled(), name="dispatch")
class CompensatoryGenericDetailView(SkylinxDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(is_compensatory_leave_enabled(), name="dispatch")
class CompensatoryForm(SkylinxFormView):
    """
    for view
    """
...
# class CompensatoryRejectForm(SkylinxFormView):
#     """
#     for view
#     """
