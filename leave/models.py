...
class LeaveRequest(SkylinxModel):
    employee_id = models.ForeignKey(
...
class RestrictLeave(SkylinxModel):
...
class LeaveGeneralSetting(SkylinxModel):
    """
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaverequestComment(SkylinxModel):
        """
...
if apps.is_installed("attendance"):
    ...
    class OverrideLeaveRequests(LeaveRequest):
        ...
        #     """
        #     WorkRecords = get_skylinx_model_class(
