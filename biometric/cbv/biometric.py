...
class BiometricNavBar(SkylinxNavView):
    """
    nav bar of the page
    """
...
class BiometricCardView(SkylinxCardView):
    """
...
class BiometricFormView(SkylinxFormView):
    """
...
class BiometricSheduleForm(SkylinxFormView):
    """
