...
from skylinx.decorators import check_integration_enabled
...
class CredentialListView(SkylinxListView):
    """
...
@method_decorator(check_integration_enabled(app_name="whatsapp"), name="dispatch")
class CredentialNav(SkylinxNavView):
    """
...
@method_decorator(check_integration_enabled(app_name="whatsapp"), name="dispatch")
class CredentialForm(SkylinxFormView):
    """
