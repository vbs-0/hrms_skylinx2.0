    ...
    def handle(self, *args, **kwargs):
        try:
            ...
            for dn, entry in results:
                ...
                # Retrieve the associated SkylinxUser if it exists
                try:
                    user = SkylinxUser.objects.get(
                    ...
                    user.save()  # Save the changes to the SkylinxUser instance
                    action = "Updated"
                except SkylinxUser.DoesNotExist:
