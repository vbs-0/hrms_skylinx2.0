...
class AllocationView(SkylinxDetailedView):
    """
    AllocationView
    """
...
class PersonalFormView(SkylinxFormView):
    """
    PersonalFormView
    """
...
class WorkFormView(SkylinxFormView):
    """
    WorkFormView
    """
...
class BankFormView(SkylinxFormView):
    """
    WorkFormView
    """
...
if app_installed("asset"):
    ...
    class AssetAllocationList(SkylinxListView):
        """
...
class Summary(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if not instance_id:
            return SkylinxRedirect(request, message=_("Employee ID missing."))
