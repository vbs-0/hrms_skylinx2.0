...
from skylinx_documents.forms import DocumentForm
from skylinx_documents.forms import DocumentRejectCbvForm as RejectForm
from skylinx_documents.forms import DocumentRequestForm, DocumentUpdateForm
...
class DocumentRequestCreateForm(SkylinxFormView):
    ...
    def get_context_data(self, **kwargs):
        ...
        self.form = choosesubordinates(
            self.request, self.form, "skylinx_documents.add_documentrequest"
        )
...
@method_decorator(login_required, name="dispatch")
class DocumentCreateForm(SkylinxFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("skylinx_documents.add_document"), name="dispatch")
class DocumentRejectCbvForm(SkylinxFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class DocumentUploadForm(SkylinxFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class DocumentRequestNav(SkylinxNavView):
    """
    For nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class DocumentListView(SkylinxListView):
    """
