...
@method_decorator(login_required, name="dispatch")
class DisciplinaryActionsList(SkylinxListView):
    """
...
@method_decorator(login_required, name="dispatch")
class DisciplinaryActionsNav(SkylinxNavView):
    """
    For nav bar
    """
...
class DisciplinaryActionsFormView(SkylinxFormView):
    """
    Form View
    """
...
class DisciplinaryActionsFormDuplicate(SkylinxFormView):
    """
    Duplicate form view
    """
...
@method_decorator(login_required, name="dispatch")
class DisciplinaryActionsDetailView(SkylinxDetailedView):
    """
    detail view of page
    """
