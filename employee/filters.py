...
class EmployeeFilter(SkylinxFilterSet):
    """
...
class DocumentPipelineFilter(SkylinxFilterSet):
    """
...
class ActionTypeFilter(SkylinxFilterSet):
...
class EmployeeWorkInformationFilter(SkylinxFilterSet):
