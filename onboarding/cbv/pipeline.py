...
class PipelineNav(SkylinxNavView):
    """
    SkylinxNavView
    """
...
class RecruitmentTabView(SkylinxTabView):
    """
    RecruitmentTabView
    """
...
class CandidateList(SkylinxListView):
    """
    CandidateList
    """
...
@method_decorator(login_required, name="dispatch")
class CandidateKanbanView(SkylinxKanbanView):
    """
    CandidateKanbanView
    """
...
class ChangeStage(SkylinxFormView):
    """
