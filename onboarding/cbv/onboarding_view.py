...
class StageCreateForm(SkylinxFormView):
    """
...
class TaskCreateForm(SkylinxFormView):
    """
...
class TaskUpdateFormView(SkylinxFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class OnboardingCandidateDetailView(SkylinxDetailedView):
    """
