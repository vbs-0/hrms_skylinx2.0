"""
skylinx_api/urls/attendance/urls.py
"""

from django.urls import path

from skylinx_api.api_views.attendance.permission_views import AttendancePermissionCheck
from skylinx_api.api_views.attendance.views import *
