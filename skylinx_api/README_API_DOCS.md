# Skylinx API Documentation

This document provides information on how to use and maintain the API documentation for Skylinx HRMS.
...
```python
from skylinx_api.docs import document_api
...
- Module tags are defined in `skylinx_api/docs.py`
...
- Ensure the URL is included in the `patterns` list in `skylinx_api/urls.py`
