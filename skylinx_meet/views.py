...
from skylinx_meet.methods import get_google_credentials
from skylinx_meet.models import *
...
@login_required
@permission_required("skylinx_meet.delete_googlecloudcredentials")
...
@login_required
@permission_required("skylinx_meet.add_googlemeeting")
@check_integration_enabled(app_name="skylinx_meet")
...
@login_required
@permission_required("skylinx_meet.delete_googlemeeting")
@check_integration_enabled(app_name="skylinx_meet")
