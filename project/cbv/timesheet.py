...
class TimeSheetNavView(SkylinxNavView):
    """
    Nav bar
    """
...
class TimeSheetList(SkylinxListView):
    """
...
class TimeSheetFormView(SkylinxFormView):
    """
...
class TimeSheetCardView(SkylinxCardView):
    """
    For card view
    """
...
class TimeSheetDetailView(SkylinxDetailedView):
    """
