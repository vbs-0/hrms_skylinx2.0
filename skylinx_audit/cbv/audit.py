...
from skylinx.decorators import permission_required
from skylinx_audit.filters import AudiTagFilter
...
@method_decorator(permission_required("skylinx_audit.view_audittag"), name="dispatch")
class AudiTagsList(SkylinxListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("skylinx_audit.view_audittag"), name="dispatch")
class AuditTagsNavView(SkylinxNavView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("skylinx_audit.add_audittag"), name="dispatch")
class AuditTagCreateForm(SkylinxFormView):
    """
