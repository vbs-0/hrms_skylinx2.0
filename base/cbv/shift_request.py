...
@method_decorator(login_required, name="dispatch")
class ShiftList(SkylinxListView):
    """
    List view
    """
...
@method_decorator(login_required, name="dispatch")
class ShitRequestNav(SkylinxNavView):
    """
    Nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class ShiftRequestTab(SkylinxTabView):
    """
    Tab View
    """
...
@method_decorator(login_required, name="dispatch")
class ShiftRequestDetailview(SkylinxDetailedView):
    """
    Detail View
    """
...
class ShiftTypeFormView(SkylinxFormView):
    """
    form view
    """
...
@method_decorator(login_required, name="dispatch")
class ShiftRequestFormView(SkylinxFormView):
    """
    Form View
    """
...
@method_decorator(login_required, name="dispatch")
class ShiftRequestFormDuplicate(SkylinxFormView):
    """
    Duplicate form view
    """
...
@method_decorator(login_required, name="dispatch")
class ShiftAllocationFormView(SkylinxFormView):
    """
    Form View
    """
