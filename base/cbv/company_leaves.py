...
@method_decorator(login_required, name="dispatch")
class CompanyleaveListView(SkylinxListView):
    """
    list view
    """
...
@method_decorator(login_required, name="dispatch")
class CompanyLeaveNavView(SkylinxNavView):
    """
    nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class CompanyLeaveDetailView(SkylinxDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class CompanyleaveFormView(SkylinxFormView):
    """
