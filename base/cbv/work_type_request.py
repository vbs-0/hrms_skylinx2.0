...
@method_decorator(login_required, name="dispatch")
class WorkRequestListView(SkylinxListView):
    """
...
@method_decorator(login_required, name="dispatch")
class WorkRequestNavView(SkylinxNavView):
    """
...
@method_decorator(login_required, name="dispatch")
class WorkTypeDetailView(SkylinxDetailedView):
    """
    Detail view of page
    """
...
@method_decorator(login_required, name="dispatch")
class DynamicWorkTypeCreateForm(SkylinxFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class WorkTypeFormView(SkylinxFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class WorkTypeDuplicateForm(SkylinxFormView):
    """
    duplicate form
    """
