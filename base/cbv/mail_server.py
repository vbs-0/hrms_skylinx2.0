...
# This page lists every tenant's SMTP host/username in one flat table —
# owner-only, regardless of any per-tenant permission a Company Admin holds.
...
class MailServerListView(SkylinxListView):
    """
...
class MailServerNav(SkylinxNavView):
    """
    Nav bar
    """
...
class MailServerFormView(SkylinxFormView):
    """
