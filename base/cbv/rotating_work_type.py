...
@method_decorator(login_required, name="dispatch")
class GeneralParent(SkylinxListView):
    """
...
class RotatingWorkNavView(SkylinxNavView):
    """
...
class RotatingWorkDetailView(SkylinxDetailedView):
    """
    Detail view of page
    """
...
class RotatingWorkTypeFormView(SkylinxFormView):
    """
    form view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("base.add_rotatingworktypeassign"), name="dispatch")
class RotatingWorkTypeDuplicateForm(SkylinxFormView):
    """
    duplicate from view
    """
