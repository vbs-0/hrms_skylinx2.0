...
@method_decorator(login_required, name="dispatch")
class HolidayListView(SkylinxListView):
    """
    list view
    """
...
@method_decorator(login_required, name="dispatch")
class HolidayNavView(SkylinxNavView):
    """
    nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class HolidayDetailView(SkylinxDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class HolidayFormView(SkylinxFormView):
    """
