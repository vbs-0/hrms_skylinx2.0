...
class MultipleApprovalConditionList(SkylinxListView):
    """
...
class MultipleApprovalConditionNav(SkylinxNavView):
    """
    Nav bar
    """
...
class MultipleApprovalConditionDetailView(SkylinxDetailedView):
    """
    detail view of page
    """
...
@method_decorator(login_required, name="dispatch")
class MultipleApprovalConditionFormView(SkylinxFormView):
    """
