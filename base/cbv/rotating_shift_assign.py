...
@method_decorator(login_required, name="dispatch")
class RotatingShiftListParent(SkylinxListView):
    """
    Parent class
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("base.view_rotatingshiftassign"), name="dispatch")
class RotatingShiftAssignNav(SkylinxNavView):
    """
    Nav bar
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("base.view_rotatingshiftassign"), name="dispatch")
class RotatingShiftDetailview(SkylinxDetailedView):
    """
    Detail View
    """
...
class RotatingShiftFormView(SkylinxFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("base.view_rotatingshiftassign"), name="dispatch")
class RotatingShiftAssignDuplicate(SkylinxFormView):
    """
    Duplicate form view
    """
