...
class EmployeeShiftSheduleNav(SkylinxNavView):
    """
...
class EmployeeShiftSheduleCreateForm(SkylinxFormView):
    """
...
class EmployeeShiftSheduleList(SkylinxListView):
...
@method_decorator(login_required, name="dispatch")
class EmployeeShiftSheduleDetailView(SkylinxDetailedView):
    """
